 ...
 * CSI205 
 * Assignment 7 - Time.java 
 * Description: This class adds a GUI to the already created TimeAndDate.java and TimeType.java
 * -Uses methods from TimeAndDate.java
 * -Creating Combo Boxes (Dropdown lists) in the UI for users to select a time and date.
 * -Users can also increment/decrement the days and seconds
 * -Output is printed into an uneditable textfield
 */
